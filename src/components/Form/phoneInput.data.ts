export type Phone = Record<'name' | 'dial_code' | 'code' | 'flag', string>;
export type PhoneOption = Record<'key' | 'title' | 'code', string>;

const countryListAllIsoData: Phone[] = [
...
export default countryListAllIsoData.map((country) => ({
